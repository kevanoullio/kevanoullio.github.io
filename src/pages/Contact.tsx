    ...
    <div className="container mx-auto px-4 text-center">
      <section className="my-16">
        ...
        <p className="mx-auto max-w-2xl text-muted-foreground">
          I'm always open to discussing new projects, creative ideas, or business opportunities.
      ...
      <section className="my-16 rounded-lg border border-border bg-muted/50 p-8">
